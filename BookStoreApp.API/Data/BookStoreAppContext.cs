...
public partial class BookStoreAppContext : IdentityDbContext<ApiUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Authors__3214EC078B313A2A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Books__3214EC071710644B");

            entity.HasIndex(e => e.Isbn, "UQ__Books__447D36EAFC1C11D2").IsUnique();
        ...
        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
            {
                Name = "User",
                NormalizedName = "USER",
                Id = "8343074e-8623-4e1a-b8c1-84fb8678c8f3"
            },
            new IdentityRole
            {
                Name = "Administrator",
        ...
        modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            ...
            {
                RoleId = "8343074e-8623-4e1a-b8c1-84fb8678c8f3",
